...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/+Yw5Xaer63RhjZTQ0>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/BLASTWALLZTV")]])
    )
...
async def next_page(bot, query):
    ...
    #     ]
        ...
        btn.insert(0, [
            InlineKeyboardButton("Sᴛᴀʀᴛ 🤖", url=f"https://telegram.me/{temp.U_NAME}"),
...
async def filter_seasons_cb_handler(client: Client, query: CallbackQuery):
    ...
    if not files:
        await query.answer("🚫 𝗡𝗼 𝗙𝗶𝗹𝗲s 𝗪𝗲𝗿𝗲 𝗙𝗼𝘂𝗻𝗱 🚫", show_alert=1)
        return
    temp.GETALL[key] = files
    settings = await get_settings(message.chat.id)
    # if 'is_shortlink' in settings.keys():
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        [
                         [
                          ...
                          InlineKeyboardButton("Mᴏᴠɪᴇ Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ", url="https://t.me/+oSmcepKMSp01NzI0")
                         ]
                        ]
                    )
                    )
                    ...
                    await query.answer(f"Hᴇʏ {query.from_user.first_name}, Tʜɪs Is Nᴏᴛ Yᴏᴜʀ Mᴏᴠɪᴇ Rᴇǫᴜᴇsᴛ. Rᴇǫᴜᴇsᴛ Yᴏᴜʀ's !", show_alert=True)
                await query.answer('Cʜᴇᴄᴋ PM, I ʜᴀᴠᴇ sᴇɴᴛ ғɪʟᴇs ɪɴ PM')
        except UserIsBlocked:
            await query.answer('Uɴʙʟᴏᴄᴋ ᴛʜᴇ ʙᴏᴛ ᴍᴀʜɴ !')
        ...
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            await query.answer("Jᴏɪɴ ᴏᴜʀ Bᴀᴄᴋ-ᴜᴘ ᴄʜᴀɴɴᴇʟ ᴍᴀʜɴ! 😒")
            return
        ident, file_id = query.data.split("#")
        files_ = await get_file_details(file_id)
        if not files_:
        ...
        btn2 = [[
                 InlineKeyboardButton('𝐌𝐀𝐈𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋📡', url=link.invite_link),
                 InlineKeyboardButton("Vɪᴇᴡ Sᴛᴀᴛᴜs", url=f"{query.message.link}")
               ],[
                 InlineKeyboardButton("Mᴏᴠɪᴇ Gʀᴘ🍿", url="https://telegram.me/blastwallztv")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://telegram.me/blastwallztv")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        buttons = [[
            InlineKeyboardButton('PASSD 🔒', callback_data='passwordm'),
            InlineKeyboardButton('U-TUBE 📺', callback_data='u_tubem'),
            InlineKeyboardButton('LYRICS 🎙', callback_data='lyricsm')
         ],[
            InlineKeyboardButton('CARBON ♠', callback_data='carbonm'),
            InlineKeyboardButton('FONT 🔡', callback_data='fontsm'),
            InlineKeyboardButton('GROUP 🤖', callback_data='groupm')
         ],[
            InlineKeyboardButton('TGRPH 🔭', callback_data='telegraphm'),
            InlineKeyboardButton('PASTE 🌀', callback_data='pastemm'),
            InlineKeyboardButton('SHARE 💢', callback_data='sharem')
         ],[
            InlineKeyboardButton('PHOTO 📸', callback_data='photom'),
            InlineKeyboardButton('JSON 🎴', callback_data='jsonm'),
            InlineKeyboardButton('TTS 🧮', callback_data='ttsm')
         ],[
            InlineKeyboardButton('⟸ Bᴀᴄᴋ', callback_data='help'),
        ...
        reply_markup = InlineKeyboardMarkup(btn)
        await query.message.edit_text(
            text=script.PSWRD_TXT,
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
    elif query.data == "u_tubem":
        btn = [[
                InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="extra")
                ]]
        await client.edit_message_media(
        ...
        reply_markup = InlineKeyboardMarkup(btn)
        await query.message.edit_text(
            text=script.TELPH_TXT,
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
    elif query.data == "sharem":
        btn = [[
                InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="extra")
                ]]
        await client.edit_message_media(
        ...
        reply_markup = InlineKeyboardMarkup(btn)
        await query.message.edit_text(
            text=script.GRP_MNG_TXT,
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
    elif query.data == "pastemm":
        btn = [[
                InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="extra")
                ]]
        await client.edit_message_media(
        ...
        reply_markup = InlineKeyboardMarkup(btn)
        await query.message.edit_text(
            text=script.PSTE_TXT,
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
    elif query.data == "jsonm":
        btn = [[
                InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="extra")
                ]]
        await client.edit_message_media(
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/mrrighteous99")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
