class script(object):
    START_TXT = """<b><b>Hᴇʏ🙋 {} ɪᴍ  <a href=https://t.me/{}>{}</a>, I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇs, Jᴜsᴛ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ As Aᴅᴍɪɴ Aɴᴅ Eɴᴊᴏʏ 😍</b>"""
...
📚 ꜰʀᴀᴍᴇᴡᴏʀᴋ : ᴘʏᴛʜᴏɴ 3
📡 ʜᴏsᴛᴇᴅ ᴏɴ : ʜᴇʀᴏᴋᴜ
📢 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ : <a href=https://t.me/+oSmcepKMSp01NzI0></b><b>𝐂𝐋𝐈𝐂𝐊 ♨️</a><b>
🌟 ᴠᴇʀsɪᴏɴ : ᴠ 4.0 [ ʙᴇᴛᴀ ]\n</b></i>"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/BLASTWALLZTV)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇQᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    FONT_TXT = """USE THE COMMAND /font WITH TEXT YOU WANT TO CHANGE AND I WILL REPLY WITH CHANGED MESSAGE."""

    CARBON_TXT = """THIS IS TEXT TO CHANGE ANY MESSAGE TO CARBON FORMAT 
    USE THE COMMAND /carbon TO SEE HOW IT WORKS."""

    GRP_MNG_TXT = """MANAGING GROUPS HERE"""

    JSON_TXT = """send command /json to see this mode."""

    LYRICS_TXT = """send command /lyrics to see this mode."""

    PSWRD_TXT = """send command /password to see this mode."""

    PSTE_TXT = """send command /paste to see this mode."""

    PIC_TXT = """send command /lyrics to see this mode.T"""

    SHR_TXT = """send command /lyrics to see this mode."""

    TELPH_TXT = """Tsend command /lyrics to see this mode.R"""

    TTS_TXT = """send command /lyrics to see this mode.A"""

    YTDL_TXT = """U-TUBE TELINA KYETUGAMBA..."""
...
ꜱᴇɴᴅ ᴍᴏᴠɪᴇ🎥 ᴏʀ ꜱᴇʀɪᴇꜱ📺 ɴᴀᴍᴇ ʜᴇʀᴇ ᴀɴᴅ ɪ ᴡɪʟʟ ᴘʀᴏᴠɪᴅᴇ ɪᴛ😘
    
╔════ᴊᴏɪɴ🔮════╗
<a href=https://t.me/+kIHJBYxTUqhjNzg0>𝐌𝐚𝐢𝐧 𝐂𝐡𝐚𝐧𝐧𝐞𝐥📡</a>
<a href=https://t.me/ug_base9>𝐓𝐫𝐚𝐧𝐳𝐥𝐚𝐭𝐞𝐝🇺🇬 𝐌𝐨𝐯𝐢𝐞𝐬</a>
...
sᴛᴇᴘ 1 : ᴍᴇꜱꜱᴀɢᴇ 🔮 <a href=https://t.me/mrrighteous99> ꧁☬ᴍʀ࿅ʀɪɢʜᴛᴇᴏᴜs☬꧂⁣</a>.

➣ Yᴏᴜ ᴄᴀɴ ᴄᴏɴɴᴇᴄᴛ ᴀs ᴍᴀɴʏ ɢʀᴏᴜᴘꜱ ʏᴏᴜ ʜᴀᴠᴇ.
...
<b>▫️<a href=https://t.me/BLASTWALLZTV> 𝐁𝐋𝐀𝐒𝐓𝐖𝐀𝐋𝐋𝐙𝐓𝐕📡 </a>
</b>"""  
